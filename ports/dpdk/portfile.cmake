...
set(DISABLE_DRIVERS "regex/cn9k,common/mvep,net/mvneta,net/mvpp2,crypto/mvsam,net/af_xdp,net/nfb,net/sfc,crypto/armv8,crypto/uadk,compress/uadk,gpu/cuda,power/amd_uncore")
...
if(NOT "pmd-crypto-ipsecmb" IN_LIST FEATURES)
  string(APPEND DISABLE_DRIVERS ",crypto/ipsec_mb")
endif()
